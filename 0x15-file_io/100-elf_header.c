...
/**
* check_elf - funtion that checks if a file is an ELF file.
...
/**
* print_class - Function that print the class of ELF header
* @e_ident: A pointer to an array 
*/
...
/**
* print_data - Function that prints data of an ELF
* @e_ident: A pointer to an array 
*/
...
/**
*print_version -Function that print the version of an ELF header.
*@e_ident: A pointer to an array 
*/
...
/**
*close_elf - Functon that closes an ELF
