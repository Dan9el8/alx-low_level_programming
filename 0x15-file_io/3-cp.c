...
/**
*create_buffer - alllocate 1024 bytes
...
/**
*close_file - file descripters
*@fd: The file descripter closed
*/
...
/**
*main - function that copies content fo files
*@argc: the number of argument
*@argv: an array of pointer
*
*Return: 0 no success
*
*Description: if theargument incorrect exit code 97
